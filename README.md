...
- **Node.js** версии 20.19+ или 22.12+ (требуется для Vite 7)
- **npm** или **yarn**
...
**Примечание:** Если у вас установлена более старая версия Node.js, используйте [nvm](https://github.com/nvm-sh/nvm) для установки совместимой версии:

```bash
# Установка Node.js 20 (если еще не установлена)
nvm install 20

# Переключение на Node.js 20
nvm use 20

# Или просто используйте nvm use (автоматически использует версию из .nvmrc)
nvm use
```

В проекте есть файл `.nvmrc`, который автоматически переключает версию Node.js при использовании `nvm use` в директории проекта.
