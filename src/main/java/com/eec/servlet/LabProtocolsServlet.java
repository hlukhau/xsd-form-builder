...
public class LabProtocolsServlet extends HttpServlet {
    ...
    private static final String SQL_GET_STATUS = ""
            ...
            + "FROM SESINT.LPREQUEST rq "
            + "JOIN SESINT.LPREQUESTSTATUS st ON st.LPREQUESTSTATUSID = rq.LPREQUESTSTATUSID "
    ...
    private static final String SQL_INSERT_REQUEST = ""
            + "INSERT INTO SESINT.LPREQUEST (REGISTRATIONCERTIFICATEID, AUTHORITYCOUNTRYCODE, LPREQUESTSTATUSID) "
            + "VALUES (?, ?, ?)";

    private static final String SQL_INSERT_REQUEST_HIST = ""
            + "INSERT INTO SESINT.LPREQUESTSTATUSHIST (LPREQUESTID, LPREQUESTSTATUSDATETIME, LPREQUESTSTATUSID, USERID) "
            + "VALUES (?, SYSDATE, ?, ?)";

    private static final String SQL_UPDATE_REQUEST_PENDING = ""
            + "UPDATE SESINT.LPREQUEST SET LPREQUESTSTATUSID = ?, CDATE = SYSDATE WHERE LPREQUESTID = ?";

    private static final String SQL_GET_XML = "SELECT LPXMLBODY FROM SESINT.LPXML WHERE LPREQUESTID = ?";
