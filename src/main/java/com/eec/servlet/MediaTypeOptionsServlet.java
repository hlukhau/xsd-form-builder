...
public class MediaTypeOptionsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!DictionaryCache.isMediaTypesLoaded()) {
                response.setStatus(HttpServletResponse.SC_SERVICE_UNAVAILABLE);
                out.print("{\"error\":\"Справочник форматов данных не загружен. Дождитесь инициализации приложения.\"}");
                System.err.println("[MediaTypeOptionsServlet] Media types cache not loaded");
                return;
            }
