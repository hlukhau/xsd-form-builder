...
/**
 * Список резолюций по карте (PPVRESOLUTION + TB_DEPKIND) — какие уровни уже наложили резолюцию.
 * GET /api/ppv/resolutions?dpaid=...
 * Ответ: { "resolutions": [ { "depKindCode": "dep0601", "depKindName": "Районный ЦГЭ" }, ... ] }
 */
public class PpvResolutionsServlet extends HttpServlet {

    private static final String SQL = ""
            + "SELECT dk.DEPKINDCODE, dk.DEPKINDNAME "
            + "FROM PPVRESOLUTION r "
