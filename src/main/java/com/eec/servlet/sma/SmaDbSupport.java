...
final class SmaDbSupport {
    ...
    static final String SQL_METADATA_SMAQ_VW = ""
            ...
            + "       NVL(c.COUNTRYNAME, 'Комиссия') AS REQUESTCOUNTRYNAME, c.COUNTRYCODE AS REQUESTCOUNTRYCODE, "
            + "       a.AUTHORITYUID AS AUTHORITYUID, "
            ...
            + "LEFT JOIN AUTHORITY a ON a.AUTHORITYID = smaq.AUTHORITYID "
    ...
    static final String SQL_METADATA_SMAQ_VW_SESINT = ""
            ...
            + "LEFT JOIN SESINT.AUTHORITY a ON a.AUTHORITYID = smaq.AUTHORITYID "
    ...
    static final String SQL_METADATA_SMAR_VW = ""
            ...
            + "       smaq.SMAQVERSION AS LINKED_SMAQVERSION, "
