...
final class SmrDbSupport {
    ...
    static final String SQL_METADATA_VW = ""
            ...
            + "       rc.COUNTRYCODE AS RESPONSECOUNTRYCODE, a.AUTHORITYUID AS AUTHORITYUID, "
            ...
            + "LEFT JOIN COUNTRY rc ON rc.COUNTRYID = smr.RESPONSECOUNTRYID "
            + "LEFT JOIN AUTHORITY a ON a.AUTHORITYID = smr.AUTHORITYID "
    ...
    static final String SQL_METADATA_VW_SESINT = ""
            ...
            + "LEFT JOIN SESINT.COUNTRY rc ON rc.COUNTRYID = smr.RESPONSECOUNTRYID "
            + "LEFT JOIN SESINT.AUTHORITY a ON a.AUTHORITYID = smr.AUTHORITYID "
    ...
    static final String SQL_METADATA_FALLBACK = ""
            ...
            + "       c.COUNTRYCODE AS RESPONSECOUNTRYCODE, a.AUTHORITYUID AS AUTHORITYUID, "
