...
/**
 * Формирует одну строку адреса по правилам ccdo:SubjectAddressDetails:
 * <Вид адреса> - <Почтовый индекс>, <Страна>, <Код территории>, <Регион>, <Район>, <Город или Населенный пункт>, <Улица>, <Номер дома> - <Номер помещения>, <Номер абонентского ящика>
 * Пустые части не выводятся, без двойных запятых и без ведущих/замыкающих разделителей.
 */
